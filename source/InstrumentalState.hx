...
class InstrumentalState extends MusicBeatState
{
	var songs:Array<SongMetadataInst> = [];
	...
	{
		songs.push(new SongMetadataInst(songName, weekNum, songCharacter));
	}
...
class SongMetadataInst
{
	...
	public function new(song:String, week:Int, songCharacter:String)
	{
		...
		this.color = InstrumentalState.coolColors[week];
	}
}