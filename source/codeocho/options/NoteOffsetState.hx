...
class NoteOffsetState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		// Characters
		gf = new Character(400, 130, 'Girlfrienda');
	...
	override public function update(elapsed:Float)
	{
		...
		if(controls.BACK)
		{
			...
			CustomFadeTransition.nextCamera = camOther;
			MusicBeatState.switchState(new codeocho.options.OptionsState());
			FlxG.sound.playMusic(Paths.music('CoversDelOcho/freakyMenu'), 1, true);
