...
class ClientPrefs {
	...
	public static var unlockSeason:Bool = false;
	...
	public static function saveSettings() {
		...
		FlxG.save.data.unlockSeason = unlockSeason;
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.unlockSeason != null) {
			unlockSeason = FlxG.save.data.unlockSeason;
		}		
		...
		if(FlxG.save.data.newUnlock != null) {
			newUnlock = FlxG.save.data.newUnlock;
		}		
		...
		if (FlxG.save.data.seasonLocked != null)
		{
			seasonLocked = FlxG.save.data.seasonLocked;
		}
