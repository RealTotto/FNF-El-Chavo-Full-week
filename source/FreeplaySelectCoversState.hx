...
class FreeplaySelectCoversState extends MusicBeatState
{
    var freeplayCats:Array<String> = ['Mi Premio', 'Danger'];
	var grpCats:FlxTypedGroup<Alphabet>;
	var curSelected:Int = 0;
	var BG:FlxSprite;
    override function create(){
        BG = new FlxSprite().loadGraphic(Paths.image('CoversDelOcho/menuBG'));
		BG.updateHitbox();
		BG.screenCenter();
		add(BG);
