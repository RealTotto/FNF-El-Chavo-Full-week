...
class NoteOffsetState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		FlxG.sound.playMusic(Paths.music('VsSuicida/offsetSong'), 1, true);
	...
	override public function update(elapsed:Float)
	{
		...
		if(controls.BACK)
		{
			...
			CustomFadeTransition.nextCamera = camOther;
			MusicBeatState.switchState(new codesuicida.options.OptionsState());
			FlxG.sound.playMusic(Paths.music('VsSuicida/freakyMenuVs'), 1, true);
