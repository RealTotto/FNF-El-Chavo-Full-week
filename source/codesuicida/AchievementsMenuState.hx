...
class AchievementsMenuState extends MusicBeatState
{
	...
	override function create() {
		...
		var menuBG:FlxSprite = new FlxSprite().loadGraphic(Paths.image('VsSuicida/menuBGBlue'));
		...
		descText.setFormat(Paths.font("GROBOLD.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
