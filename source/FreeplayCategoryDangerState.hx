...
class FreeplayCategoryDangerState extends MusicBeatState
{
	var songs:Array<SongMetadataleCools> = [];
	...
	{	
		...
		PlayState.isFreeplayDanger = true;
		...
		var initSonglist = CoolUtil.coolTextFile(Paths.txt('freeplayDanger'));
	...
	{
		songs.push(new SongMetadataleCools(songName, weekNum, songCharacter, colors));
