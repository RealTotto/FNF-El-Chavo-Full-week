...
class FreeplayCategoryRoadState extends MusicBeatState
{
	var songs:Array<SongMetadataleCool> = [];
	...
	{	
		...
		PlayState.isFreeplayCovers = true;
		...
		var initSonglist = CoolUtil.coolTextFile(Paths.txt('freeplayRoad'));
	...
	{
		songs.push(new SongMetadataleCool(songName, weekNum, songCharacter, colors));
