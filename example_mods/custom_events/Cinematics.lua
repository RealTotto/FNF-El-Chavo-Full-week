...
function onUpdate()
	...
	doTweenAlpha('AlphaTween8', 'healthBarOverlay', 0, 0.1)
	doTweenAlpha('AlphaTween9', 'timeTxt', 0, 0.1)
	doTweenAlpha('AlphaTween10', 'iconChavo', 0, 0.1)
	doTweenAlpha('AlphaTween11', 'iconQuico', 0, 0.1)
	doTweenAlpha('AlphaTween12', 'return1', 0, 0.1)
	doTweenAlpha('AlphaTween13', 'return2', 0, 0.1)
	doTweenAlpha('AlphaTween14', 'velocity', 0, 0.1)
	doTweenAlpha('AlphaTween15', 'velocity12', 0, 0.1)
	...
	doTweenAlpha('AlphaTween8', 'healthBarOverlay', 1, 0.1)
	doTweenAlpha('AlphaTween9', 'timeTxt', 1, 0.1)
	doTweenAlpha('AlphaTween10', 'iconChavo', 1, 0.1)
	doTweenAlpha('AlphaTween11', 'iconQuico', 1, 0.1)
	doTweenAlpha('AlphaTween12', 'return1', 1, 0.1)
	doTweenAlpha('AlphaTween13', 'return2', 1, 0.1)
	doTweenAlpha('AlphaTween14', 'velocity', 1, 0.1)
	doTweenAlpha('AlphaTween15', 'velocity12', 1, 0.1)
